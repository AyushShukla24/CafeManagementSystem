...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateBill(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (validateRequestMap(requestMap)) {
                ...
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(CafeConstant.STORE_LOCATION + "\\" + fileName + ".pdf"));
    ...
    public ResponseEntity<List<Bill>> getBills() {
        ...
        if (jwtFilter.isAdmin()) {
            ...
            list = billDao.getBillByUserName(jwtFilter.getUserName());
        }
